       ...
       <!-- Left Image-->
        <div class="span5">
          <ul class="thumbnails mainimage">
            <li class="span5">
              <a  rel="position: 'inside' , showTitle: false, adjustX:-4, adjustY:-4" class="thumbnail cloud-zoom" href="{!! asset('resources/upload/images/'.$product_detail->image) !!}">
                <img src="{!! asset('resources/upload/images/'.$product_detail->image) !!}" alt="" title="">
              </a>
            </li>
            @foreach($image as $item_image)
            <li class="span5">
              <a  rel="position: 'inside' , showTitle: false, adjustX:-4, adjustY:-4" class="thumbnail cloud-zoom" href="{!! asset('resources/upload/images/'.$item_image->image) !!}">
                <img  src="{!! asset('resources/upload/images/'.$item_image->image) !!}" alt="" title="">
              </a>
            </li>
            @endforeach
          </ul>
       ...
       @foreach($product_cate as $item_product_cate)
        <li class="span3">
          ...
          <div class="thumbnail">
            ...
            <a href="#"><img alt="" src="{!! asset('resources/upload/images/'.$item_product_cate->image) !!}"></a>
            <div class="pricetag">
